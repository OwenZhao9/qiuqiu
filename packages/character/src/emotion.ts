...
export const RULES: readonly EmotionRule[] = [
  {
    ...
    priority: 90,
    scope: 'full',
    pattern: /(生气|恼火|气死|太过分|不像话|忍无可忍|无法接受|让人火大)/u,
    emotionId: '21'
  },
  {
    id: 'R02',
  ...
  },
  {
    ...
    priority: 85,
    scope: 'full',
    pattern: /(哇塞|天呐|天哪|我的天|居然|竟然|没想到|不会吧|真的假的|万万没想到)/u,
    emotionId: '13'
  },
  { id: 'R04', priority: 85, scope: 'lastSentence', pattern: /[！!]{2,}\s*$/u, emotionId: '13' },
  {
    id: 'R05',
    priority: 80,
    scope: 'full',
    pattern:
      /(害羞|脸红|夸得我|别夸我|(?:你|您)(?:太)?过奖|(?:你|您)这么夸|受宠若惊|有点(?:小)?骄傲|嘿嘿)/u,
    emotionId: '14'
  },
  {
    id: 'R06',
    priority: 70,
    scope: 'full',
    pattern: /(抱歉|对不起|很遗憾|帮不上|做不到|没能|辜负|不好意思[，,])/u,
    emotionId: '12'
  },
  {
    id: 'R07',
  ...
  },
  {
    ...
    priority: 60,
    scope: 'full',
    pattern: /(没办法|无能为力|只能这样|也只好|无奈|摊手|爱莫能助|无可奈何)/u,
    emotionId: '18'
  },
  {
    id: 'R09',
    priority: 60,
    scope: 'full',
    pattern: /(?:确实|的确)?(?:有点|有些)?(?:棘手|难办|无解)/u,
    emotionId: '18'
  },
  {
    id: 'R10',
    ...
    scope: 'tail80',
    pattern:
      /(你是(?:不是)?(?:想|要|说)|是否需要|要不要|需不需要|请问|想跟你确认|能不能再说说|方便说说)/u,
    emotionId: '11'
  },
  { id: 'R11', priority: 50, scope: 'lastSentence', pattern: /[？?]\s*$/u, emotionId: '11' },
  {
    id: 'R12',
    priority: 45,
    scope: 'full',
    pattern:
      /(没(?:太)?(?:看懂|听懂|明白)|不太确定|不太理解|理解不了|(?:有点|有些)(?:困惑|迷糊|懵))/u,
    emotionId: '20'
  },
  {
    id: 'R13',
    priority: 45,
    scope: 'full',
    pattern: /(对不上|前后矛盾|互相冲突|说法不一致|信息不一致|自相矛盾)/u,
    emotionId: '20'
  },
  {
    id: 'R14',
    priority: 40,
    scope: 'full',
    pattern: /(搞定|完成了|已经(?:记下|记住|保存|更新|整理好)|处理好了|一切正常|没问题了|妥了)/u,
    emotionId: '19'
  },
  {
    id: 'R15',
    priority: 40,
    scope: 'full',
    pattern: /(?:总算|终于)(?:是)?(?:弄好|搞定|对上|跑通|理清)/u,
    emotionId: '19'
  },
  {
    id: 'R16',
    priority: 30,
    scope: 'full',
    pattern: /(开心|高兴|太好了|真棒|不错(?:呀|哦|啊)?|喜欢|有意思|好玩|期待|哈哈+)/u,
    emotionId: '10'
  },
  {
    id: 'R17',
...
export const REFUSAL =
  /(我(?:不能|无法|没法)(?:帮你)?(?:提供|回答|完成|做|参与)|超出(?:我的)?(?:能力|权限|范围)|(?:这|该)(?:类|个)(?:问题|请求)我(?:不便|不能)|建议(?:你)?(?:咨询|寻求)(?:专业|医生|律师|心理)|我不是(?:医生|律师|心理咨询师)|不适合由我来(?:判断|决定)|我们的关系(?:是|只是))/u;
